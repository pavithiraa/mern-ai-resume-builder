import { FilePenLineIcon, PencilIcon, Plus, TrashIcon, UploadCloudIcon } from "lucide-react";
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          <button className="w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed 
      ...
      transition-all duration-300 cursor-pointer">
        ...
        <div className="grid grid-col-2 sm:flex flew-wrap gap-4">
          {allResumes.map((resume,i)=>{
          const baseColor = colors[i%colors.length]
          return(
            <button key={i} className="relative w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2  border hover:shadow-lg transition-all duration-300 cursor-pointer" 
