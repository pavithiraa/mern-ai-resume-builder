import { FilePenLineIcon, PencilIcon, Plus, TrashIcon, UploadCloud, UploadCloudIcon, X } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          <button
            ...
            className="w-full sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed 
            ...
            return (
              ...
              >
                ...
                <div onClick={e=>e.stopPropagation()} className="absolute top-1 right-1 hidden group-hover:flex items-center gap-1">
                  <TrashIcon className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors cursor-pointer" onClick={()=>deleteResume(resume._id)}/>
                  <PencilIcon className="size-7 p-1.5 hover:bg-white/50 rounded text-slate-700 transition-colors cursor-pointer" onClick={()=>{setEditResumeId(resume._id); setTitle(resume.title)}} />
                </div>
              </button>
            );
          })}
          ...
          >
            ...
            >
              ...
              <input
                ...
                className="w-full mb-4 px-4 py-2 focus:border-green-600 ring-green-600 required"
              />
          ...
          >
            ...
            >
              ...
              <div>
                ...
                className="hidden" onChange={(e) => setResume(e.target.files[0])} />
              </div>
              <button className="w-full py-2 bg-green-500 text-white rounded hover:bg-green-700 transition-colors">
                Upload Resume
              </button>
